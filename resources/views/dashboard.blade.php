    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <header class="bg-white/95 backdrop-blur-md border-b border-slate-200 sticky top-0 z-30 shadow-xs px-6 py-4 sm:py-5 flex items-center justify-between no-print">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('report.tear-sheet', ['scenario_id' => $activeScenario?->id ?? '']) }}" 
                   class="px-3.5 py-1.5 text-xs font-semibold bg-slate-900 hover:bg-slate-800 text-white rounded-xl shadow-xs transition-all flex items-center gap-1.5 cursor-pointer">
